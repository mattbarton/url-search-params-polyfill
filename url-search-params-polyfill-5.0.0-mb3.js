...
(function(self) {
    ...
    if (nativeURLSearchParams) {
        ...
        if (decodesPlusesCorrectlyNative && decodesPlusesCorrectlyNative.get) {
            decodesPlusesCorrectly = decodesPlusesCorrectlyNative.get('s') === '+';
        } else {
            console.log('decodesPlusesCorrectlyNative.get undefined')
        }
    }
    ...
    var encodesAmpersandsCorrectly = nativeURLSearchParams ? (function() {
            ...
            if (!ampersandTest || !ampersandTest.append) {
                return false
            }
